...
public class SignupThree extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource() == submit)
        {
              ...
              {
                   accntType = "Current Account";
              }
              else  if(r4.isSelected())
              {
                   accntType = "Recurring Deposit Account";
              }
              ...
              try{
                  if(accntType.equals(""))
                  {
                      ...
                      String q1 = "insert into signupThree values('"+formno+"','"+accntType+"','"+cardno+"','"+pin+"','"+facility+"')";
